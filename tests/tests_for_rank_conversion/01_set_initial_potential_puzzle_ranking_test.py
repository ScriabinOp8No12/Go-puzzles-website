from backend.utils.sgf_mill_set_initial_potential_puzzle_ranking import set_potential_puzzle_difficulty

def test_set_potential_puzzle_difficulty():
  ...
  # Test case 1: dan ranks, 5d vs 1d from KGS
  difficulty1 = set_potential_puzzle_difficulty(sgf_data1)
  assert difficulty1 == 2300, f"Expected 2300, got {difficulty1}"

  # Test case 2: pro ranks
  difficulty2 = set_potential_puzzle_difficulty(sgf_data2)
  assert difficulty2 == 3000, f"Expected 3000, got {difficulty2}"

  # Test case 3: no ranks
  difficulty3 = set_potential_puzzle_difficulty(sgf_data3)
  assert difficulty3 == 1500, f"Expected 1500, got {difficulty3}"

  # Test case 4: kyu ranks, 6k vs 7k from OGS
  difficulty4 = set_potential_puzzle_difficulty(sgf_data4)
  assert difficulty4 == 1450, f"Expected 1450, got {difficulty4}"

  # Test case 5: dan ranks, 3d vs 4d from OGS
  difficulty5 = set_potential_puzzle_difficulty(sgf_data5)
  assert difficulty5 == 2350, f"Expected 2350, got {difficulty5}"

  # Test case 6: kyu vs dan ranks, 3k vs 1d from OGS
  difficulty6 = set_potential_puzzle_difficulty(sgf_data6)
  assert difficulty6 == 1950, f"Expected 1950, got {difficulty6}"

  # Test case 7: fox dan ranks, 8 dan against 8dan
  difficulty7 = set_potential_puzzle_difficulty(sgf_data7)
  assert difficulty7 == 2800, f"Expected 2800, got {difficulty7}"

  # Test case 8: fox kyu ranks, 7kyu against 7kyu
  difficulty8 = set_potential_puzzle_difficulty(sgf_data8)
  assert difficulty8 == 1400, f"Expected 1400, got {difficulty8}"

  # Test case 9: fox pro ranks, 9p (dan is in there too)
  difficulty9 = set_potential_puzzle_difficulty(sgf_data9)
  assert difficulty9 == 3000, f"Expected 3000, got {difficulty9}"

  print("\nPuzzle difficulty1:", difficulty1)
  ...
  print("Puzzle difficulty6:", difficulty6)
