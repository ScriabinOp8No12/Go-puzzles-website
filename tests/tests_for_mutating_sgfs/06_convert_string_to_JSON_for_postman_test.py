...
def test_convert_string_to_json_for_postman():
  katago_json_output = '''{
    "createdPuzzles": [
        {
            "id": 1,
    ...
    "createdPuzzles": [
        {
            ...
            "difficulty": 1500,
            "updatedAt": "2023-09-27 14:16:12",
            "createdAt": "2023-09-27 14:16:12"
        },
        {
            "thumbnail": "https://res.cloudinary.com/dn8rdavoi/image/upload/v1693682857/no_image_thumbnail_tpwuc0.jpg",
            "id": 2,
...
'''
  ...
  assert '\\n' in json_output, "The escaped string does not contain '\\n'"
  assert json_output[0] == '"', f"The output does not start with a double quote: {json_output[0]}"
