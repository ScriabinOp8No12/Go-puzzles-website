...
### Potential Puzzles (Endpoints for potential puzzles page generated by KataGo AI Analysis Engine)

- `GET /api/potential_puzzles`: Get an array of all potential puzzles and their associated Sgf thumbnail
...
### Get Potential Puzzles

Retrieve all potential puzzles generated by KataGo AI
