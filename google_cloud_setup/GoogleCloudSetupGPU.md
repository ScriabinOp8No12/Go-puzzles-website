...
NOTE: Since I'm reserving both a static external and internal IP address, each one charges me a cent an hour regardless of if the VM is on or not.
That's roughly $15 a month without doing anything.
