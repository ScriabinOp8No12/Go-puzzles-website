// drop the submit button, it has default behavior that's too hard to work around it seems
// just mimic the upload button on OGS, also try without limiting the number of SGFs they can upload
// at once, just get the table to populate first!
