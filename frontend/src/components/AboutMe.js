  ...
  return (
    <div className="about-me-outer-container">
      ...
      <p className="about-me-paragraph-text">
        ...
        wrote code for projects I cared about, and thus wasn't motivated. When I started teaching Go online after college, I wanted to automate the tedious tasks, and that was when I learned how to code.
      ...
      <p className="about-me-paragraph-text">
        ...
        a lot of time, and I enjoyed discussing and solving problems. I built a web scraper that saves my Dad 16 hours annually.
        Code here: {" "}
      ...
      <p className="about-me-paragraph-text">
        3 months later, I decided to apply for a coding bootcamp. I was accepted into
        App Academy, and have been working on this Go project since May, 2023. Whenever I learned
      ...
      <p className="about-me-paragraph-text">
        Outside of programming and teaching Go, I love playing Piano (I started at age 5), tennis,
        League of Legends, and watching anime. I am thankful for my wonderful family and friends because they encourage me to become the best version of myself.
      </p>
          {/* <figure>
