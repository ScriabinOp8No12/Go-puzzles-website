...
const BasicRulesQuiz = () => {
  ...
  return (
      ...
      <section className="question">
        ...
        {hasAttempted && (
          <button className="show-all-answers-button" onClick={toggleAllAnswers}>
        ...
        <section className="question">
          <p>
            2. True or False: White typically plays first, then black plays
            next.
          </p>
          <div className="option">
            <input
          ...
          {hasAttempted && (
            <div className="answer">
              {showAllAnswers && (
                <p>
                  False. Stones are placed on the intersections, not the
                  squares.
                </p>
              )}
            </div>
        ...
        <section className="question">
          <p>
            3. True or False: Territory is the number of intersections
            surrounded.
          </p>
          <div className="option">
            <input
          ...
          <div className="quiz-content">
            ...
            <div className="option">
              ...
              <label htmlFor="question6-atari2">
                Letting the opponent know that their stone(s) are at 1 liberty
                and are about to be captured.
              </label>
            </div>
            <div className="option">
              <input
            ...
            <div className="option">
              ...
              <label htmlFor="question6-atari4">
                The extra half point white gets (breaking ties) to offset
                black's first move.
              </label>
            </div>
          </div>
