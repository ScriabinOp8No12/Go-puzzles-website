      ...
      <div className="content-section">
        ...
        <div className="content-text-section">
          ...
          <div className="content-image-section">
            ...
            />
            <p>
              White gets captured at 5 on black's next move. Black pushes at 1
              to cut or separate the 3 white stones from the H7 stone. White
              tries to connect back to the H7 stone with the move at 2. Black
              puts white in atari by playing at 3, forcing white to connect at 4
              to save the 3 white stones. But then black captures at 5!{" "}
            </p>
          </div>
        </div>
      </div>
