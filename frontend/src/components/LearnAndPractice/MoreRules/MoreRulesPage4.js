    ...
    <div className="main-content">
      ...
      <div className="content-section">
        ...
        <div className="content-text-section">
          <p>
            A <span className="important-text">ko</span> is a situation where both players can capture the opponent's single stone,
            but the opponent could capture a single stone right back, causing an infinite loop.
          </p>

          <p>
            To deal with this potential never ending situation, the rule is that when one player takes the ko, the opponent is not allowed to
            take the ko back, until they've played somewhere else on the board first.
          </p>
