      ...
      <div className="content-section">
        <div className="content-text-section">
          ...
          <div className="content-image-section">
            ...
            />
            <p>
              Black just played G5 and captured the white stone at F5. Notice
              how white could just play F5 and capture the G5 black stone. This
              would never end. The ko rule is that white must play somewhere
              else on the board first, before they are allowed to take the ko
              back.
            </p>
          </div>
          <div className="content-image-section">
            ...
            />
            <p>
              White could play at 1, if black responds at 2, white can then take
              the ko back with 3.
            </p>
          </div>
        </div>
