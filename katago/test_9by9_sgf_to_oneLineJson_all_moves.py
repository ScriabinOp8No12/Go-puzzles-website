...
sgf_data = "(;GM[1]FF[4]CA[UTF-8]AP[CGoban:3]ST[2] RU[Japanese]SZ[9]KM[6.50] AW[fa][fb][cc][ec][ed][ee][cf][ef]AB[ga][gb][gc][gd][ge][gf][gg])"
print(sgf_to_one_line_json(sgf_data))

# Output is: {"id": "sgfTest", "rules": "japanese", "komi": 6.5, "boardXSize": 9, "boardYSize": 9, "initialPlayer": "B", "analyzeTurns": [0], "initialStones": [["B", "G5"], ["B", "G8"], ["B", "G3"], ["B", "G6"], ["B", "G9"], ["B", "G4"], ["B", "G7"], ["W", "E5"], ["W", "C7"], ["W", "E4"], ["W", "E6"], ["W", "E7"], ["W", "C4"], ["W", "F8"], ["W", "F9"]], "moves": []}
