...
from katago.clean_sgf_add_comments_endpoint import clean_sgf, convert_to_sgf, process_katago_output, add_comments_to_sgf
...
def test_clean_sgf():
  ...
  logging.info(f"Cleaned SGF: {cleaned_sgf_string}")
